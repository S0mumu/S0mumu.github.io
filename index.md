...
![图片10](/Users/rb/Documents/GitHub/myPersonalStudy/图片/图片10.jpeg)
...
<img src="/Users/rb/Documents/GitHub/myPersonalStudy/图片6.png" alt="图片6" style="zoom: 67%;" />
...
https://zhuanlan.zhihu.com/p/158593966
...
https://www.zhihu.com/search?type=content&q=mybatis

![img](https://pic1.zhimg.com/v2-bc338a28008c9e0fa50deb6010ddf95c_b.jpg)
...
在抽象工厂模式中，接口是负责创建一个相关对象的工厂，不需要显式指定它们的类。每个生成的工厂都能按照工厂模式提供对象。抽象工厂模式（Abstract Factory Pattern）是围绕一个超级工厂创建其他工厂。该超级工厂又称为其他工厂的工厂。这种类型的设计模式属于创建型模式，它提供了一种创建对象的最佳方式。
